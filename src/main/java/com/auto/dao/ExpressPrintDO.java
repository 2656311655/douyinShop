...
public class ExpressPrintDO {
   ...
   public void setExpressPlatform(String expressPlatform) {
      this.expressPlatform = expressPlatform;
   }
   ...
   public String getDouyinShop() {
      return douyinShop;
   }
   public void setDouyinShop(String douyinShop) {
      this.douyinShop = douyinShop;
   }
