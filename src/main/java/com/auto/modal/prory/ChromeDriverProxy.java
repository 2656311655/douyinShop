...
import com.auto.modal.vo.ResponseBodyVo;
...
public class ChromeDriverProxy extends ChromeDriver {
    ...
    private static final int CHROME_DRIVER_PORT = 9223;
    ...
    public ResponseBodyVo getResponseBody(String requestId) {
        ...
        try {
            ...
            System.out.println(JSONObject.toJavaObject(data, ResponseBodyVo.class));
